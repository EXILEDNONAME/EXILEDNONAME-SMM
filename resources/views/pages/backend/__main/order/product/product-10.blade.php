    ...
    <div class="card card-custom gutter-b" data-card="true">
      ...
      <div class="card-body">
        <form method="POST" id="exilednoname-form" action="{{ URL::current() }}/../" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
          ...
          <input class="form-control" name="id_product" type="hidden" value="10">
          ...
          <div class="form-group row">
            ...
            <div class="col-lg-9">
              {{ Html::number('quantity', (isset($data->quantity) ? $data->quantity : '10'))->class([ $errors->has('quantity') ? 'form-control form-control-solid is-invalid' : 'form-control form-control-solid'])->id('quantity')->isReadOnly() }}
