      ...
      <div class="card-body">
        <form method="POST" id="exilednoname-form" action="{{ URL::current() }}/../" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
          ...
          <div class="form-group row">
            ...
            <div class="col-lg-9">
              {{ Html::text('quantity', (isset($data->quantity) ? $data->quantity : ''))->class([ $errors->has('quantity') ? 'form-control is-invalid' : 'form-control'])->required()->id('quantity') }}
              @error('quantity') <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span> @enderror
              <span class="form-text text-muted"> Min. 50 - Max. 100</span>
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-lg-9">
              {{ Html::text('price', (isset($data->price) ? $data->price : ''))->class([ $errors->has('price') ? 'form-control form-control-solid is-invalid' : 'form-control form-control-solid'])->isReadOnly()->id('result') }}
